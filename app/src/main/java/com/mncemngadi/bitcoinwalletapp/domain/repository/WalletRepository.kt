...
interface WalletRepository {
    ...
    suspend fun getLatestRates(base: String, symbols: List<String>): Either<Failure, List<CurrencyRate>>
    suspend fun getFluctuation(base: String, symbols: List<String>, startDate: String, endDate: String): Either<Failure, Map<String, Double>>
}
